...
export function LoginButton() {
  ...
  return (
    <button
      onClick={handleAuth}
      disabled={disabled}
      className={`px-4 py-1.5 rounded-full transition-colors text-sm font-medium bg-white bg-opacity-90 hover:bg-opacity-100 text-zinc-800 border border-zinc-300 disabled:opacity-50`}
    >
      {text}
    </button>
  );
