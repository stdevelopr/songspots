...
export interface UseVibeOperationsProps {
  visibleVibes: Vibe[];
}

export interface VibeHighlightConfig {
  transform: string;
  boxShadow: string;
  borderColor: string;
  borderWidth: string;
...
// Constants
export const VIBE_OPERATION_CONSTANTS = {
  HIGHLIGHT_DURATION: 2500,
  MOBILE_BREAKPOINT: 768,
  HIGHLIGHT_Z_INDEX: '1001',
} as const;

export const VIBE_HIGHLIGHT_STYLES: VibeHighlightConfig = {
