          ...
          {isViewingOwnProfile && (
            <div className="bg-gray-50/50 rounded-md p-2 border border-gray-100 transition-all duration-300">
              <div className="flex gap-2 items-center justify-center">
                <button
                  onClick={() => onEdit(pin)}
                  className="px-2 py-1 text-blue-700 bg-blue-50/60 hover:bg-blue-100 border border-blue-200 rounded transition-colors text-xs flex-1 justify-center flex items-center gap-1"
                  title="Edit memory"
                >
                ...
                <button
                  ...
                  className="px-2 py-1 text-red-700 bg-red-50/60 hover:bg-red-100 border border-red-200 rounded transition-colors text-xs flex-1 justify-center flex items-center gap-1"
                  title="Delete memory"
                >
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
