...
const AVAILABLE_PLATFORMS = [
  ...
  { 
    ...
    color: 'from-red-50 to-red-100 border-red-200 text-red-700 hover:from-red-100 hover:to-red-200 hover:text-red-800'
  },
  { 
    name: 'Website', 
  ...
  { 
    ...
    color: 'from-green-400 to-green-500 border-green-300 text-white hover:from-green-500 hover:to-green-600'
  },
  { 
    name: 'GitHub', 
...
export function getPlatformMeta(platformName: string) {
  ...
  return {
    ...
    color: 'from-gray-50 to-gray-100 border-gray-200 text-gray-700 hover:from-gray-100 hover:to-gray-200 hover:text-gray-800',
  };
}
              ...
              <div key={link.id} className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2 min-w-0 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    />
                    {isEmpty && (
                      <p className="text-xs text-red-600 mt-1">URL required or this link will be removed</p>
                    )}
                  </div>
                </div>
                <button
