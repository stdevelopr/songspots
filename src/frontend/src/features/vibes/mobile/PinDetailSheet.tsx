        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            {('address' in vibe) && (vibe as any).address && (
              <div className="mt-1 text-mobile-xs text-gray-600 flex items-start gap-1 min-w-0 max-w-full overflow-hidden">
                <svg className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="block line-clamp-2 break-words">{(vibe as any).address}</span>
              </div>
            )}
            {vibe.owner && (
              <Link
