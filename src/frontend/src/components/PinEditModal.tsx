      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="editPinDescription" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div>
              <label htmlFor="editMusicLink" className="block text-sm font-medium text-gray-700 mb-2">
                Music Link (Optional)
              </label>
              <input
                type="url"
